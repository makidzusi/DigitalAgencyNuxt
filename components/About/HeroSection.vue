      ...
      <section class="max-w-screen-2xl mx-auto">
        <div class="flex flex-wrap justify-between mb-8 md:mb-16">
          ...
          >
            <h1
              id="title-about"
              class="text-black-800 text-4xl sm:text-5xl font-bold mb-4 md:mb-8"
            >
          ...
          <div class="w-full lg:w-2/3 flex mb-12 md:mb-16">
            <div
              class="bg-gray-100 rounded-lg shadow-lg overflow-hidden relative z-2 top-12 md:top-16 left-12 md:left-16 -ml-12 lg:ml-0"
            >
              <img
            ...
            <div class="bg-gray-100 rounded-lg shadow-lg overflow-hidden">
              <img
                src="https://img.freepik.com/free-photo/programmer-scanning-screen-his-smartwatch-with-smartphone-camera_1098-18710.jpg?w=2000"
                loading="lazy"
        ...
        <div
          class="flex flex-col md:flex-row-reverse justify-between items-center gap-8"
        >
          <div class="flex justify-center lg:justify-start items-center gap-4">
            ...
            >
              {{ $t("aboutHeroSection.socials") }}</span
            >
...
onMounted(() => {
  var textWrapper = document.querySelector("#title-about");
